    ...
    <Disclosure as="nav" class="h-16" v-slot="{ open }">
        <div class="max-w-full mx-auto">
            <div class="relative flex justify-between h-16">
                ...
                <div class="absolute inset-y-0 flex items-center pr-2 right-12 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    <ThemeToggle />
                </div>
            </div>
        </div>

        <DisclosurePanel class="absolute z-20 w-full border-b-2 shadow-lg dark:bg-slate-700 bg-slate-100 sm:hidden border-b-emerald-500/50">
            <nav class="p-1 space-y-1">
                ...
                <TopNavLink to="/components"
                    ...
                    active-class="pl-4 text-emerald-500 border-emerald-500 bg-emerald-50 text-emerald-700"
                    inactive-class="border-transparent" >
                    Components</TopNavLink >
                <TopNavLink to="/products"
                    class="z-20 block hover:bg-emerald-50 hover:border-emerald-300 hover:text-gray-700 dark:hover:text-gray-200"
                    active-class="pl-4 text-emerald-500 border-emerald-500 bg-emerald-50 text-emerald-700"
                    inactive-class="border-transparent" >
                    Products</TopNavLink >
